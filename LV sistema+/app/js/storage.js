...
function asegurarDatosBaseMinimos() {
    if (!Array.isArray(listasPrecios) || listasPrecios.length === 0) {
        listasPrecios = [
            { codigo: 1, nombre: "Lista 1", porcentaje: 50, activo: true },
            { codigo: 2, nombre: "Lista 2", porcentaje: 15, activo: true },
            { codigo: 3, nombre: "Lista 3", porcentaje: 20, activo: true },
            { codigo: 4, nombre: "Lista 4", porcentaje: 10, activo: true }
        ];
    ...
    if (!Array.isArray(zonas) || zonas.length === 0) {
        zonas = [
            { codigo: 1, nombre: "General", descripcion: "Clientes sin zona especifica", activo: true },
            { codigo: 2, nombre: "Centro", descripcion: "Zona comercial central", activo: true },
            { codigo: 3, nombre: "Norte", descripcion: "Reparto zona norte", activo: true },
            { codigo: 4, nombre: "Sur", descripcion: "Reparto zona sur", activo: true }
        ];
        guardarZonas();
    }
    ...
    if (!Array.isArray(rubros) || rubros.length === 0) {
        rubros = [
            { codigo: 1, nombre: "Alimentos", descripcion: "Productos de almacen", activo: true }
        ];
        guardarRubros();
    }
}
