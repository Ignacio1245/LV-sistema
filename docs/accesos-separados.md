...
- Panel administrativo: cerrado y verificado.
- `catalogo.html`: listo para pedido simple por WhatsApp.
- `vendedores.html`: listo para pedido movil por WhatsApp con login Supabase si esta configurado.
- Ambos accesos renderizan textos de clientes/productos con proteccion basica para evitar HTML inesperado.
...
node tools/probar-accesos-publicos.js
```
